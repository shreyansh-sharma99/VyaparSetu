...
const AddPlans: React.FC = () => {
    ...
    const onSubmit = async (data: PlanFormData) => {
        ...
        try {
            const resultAction = await dispatch(addNewPlan(submissionData));
            if (addNewPlan.fulfilled.match(resultAction)) {
    ...
    return (
        <div className="">
            <PageMeta title={`Add Plans | ${import.meta.env.VITE_PLATFORM_NAME}`} description={`This is ${import.meta.env.VITE_PLATFORM_NAME} Platform`} />
            <ComponentCard
